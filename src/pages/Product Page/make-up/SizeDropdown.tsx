...
const SizeDropdown = ({ product }: SizeDropdownProps ) => {
  ...
  return (
    <div
      ...
      className=" b-shadow bg-white z-[1000] relative rounded-[8px] border-[1px] w-[90%] flex cursor-pointer overflow-hidden   border-[black] "
    >
      <div className="w-[100%] ">
        <div className="">
          <p
            className={
              !selectedSize
                ? "text-[gray] pl-3 w-[80%]    truncate font-[200] p-2 justify-center h-[40px]"
              ...
              return (
                <div>
                  <p
                    ...
                    className={
                      size !== selectedSize
                        ? " hover:bg-[#F0F0F0] pl-3 p-[2px] font-[400] xs:p-[10px]"
                        : "xs:p-[10px] bg-[#D9D9D9] pl-3 p-[2px] font-[400]"
                    }
                  >
                    {size}
                  </p>
